...
- **Supports**: vLLM >= 0.6.0
- **Hardware**: Tenstorrent Processing Accelerator
- **Python**: >= 3.12
...
- `ARCH_NAME`: Tenstorrent device architecture
- `VLLM_TARGET_PLATFORM`: Set to `tt`
- `WH_ARCH_YAML`: YAML description of device
- `MESH_DEVICE`: Mesh device type (see `tt_worker.py`)
